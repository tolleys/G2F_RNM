...
for(i in 1:2126){
  ...
  data6 <- cbind(Geno, f, LocYearEnvGradStandardized, GEBV)
...
2126*12*86 #2194032. Worked for all 2126 hybrids, 12 GP cross validation(ish), 86 environments
...
head(GenPredCor_BLUP)

boxplot(GenPredCor_BLUP$Correlation ~ GenPredCor_BLUP$Type)
